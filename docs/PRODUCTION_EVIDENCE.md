...
| `reference-deployment`         | Exact Kubernetes runtime and NetworkPolicy enforcement markers plus external-secret provenance, centralized telemetry, alerts, and rollback ownership |
